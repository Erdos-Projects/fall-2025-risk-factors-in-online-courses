...
- Python scripts:
  - `data_merger.py` - python script, called in `main_pipeline.ipynb` when necessary to execute the merging of the raw OULAD data, after downloading the zip file from their website
